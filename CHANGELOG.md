...
- **Security**: Force transitive `postcss` to `^8.5.18` via root
  `overrides` to close GHSA-r28c-9q8g-f849 (high, path traversal in
  source-map auto-loading). `vitest@4.1.10` pulled `vite@8.1.3` →
