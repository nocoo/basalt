		...
		function FormOwnerGroup({ formId }: { formId: string }) {
			return (
				<div>
					...
					<Checkbox.Group form={formId} defaultValue={["a"]} aria-label="Group Owner">
						<Checkbox.Item value="a" name="choice" form={formId}>
							Alpha
						</Checkbox.Item>
						<Checkbox.Item value="b" name="choice" form={formId}>
							Beta
						</Checkbox.Item>
					</Checkbox.Group>
				</div>
		...
		function FormOwnerSwitchGroup({ formId }: { formId: string }) {
			return (
				<div>
					...
					<Checkbox.Group form={formId} defaultValue={["a"]} aria-label="Switch Group Owner">
						<Checkbox.Item value="a" name="choice" form={formId}>
							Alpha
						</Checkbox.Item>
						<Checkbox.Item value="b" name="choice" form={formId}>
