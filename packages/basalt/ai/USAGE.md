...
It contains:
- **116 Exported Modules** (1 root barrel, components, charts, providers)
- **105 Ready Catalog Entries** with full API definitions
- **722 Public Symbols** (386 runtime values, 336 TypeScript types)
