...
It contains:
- **112 Exported Modules** (1 root barrel, components, charts, providers)
- **101 Ready Catalog Entries** with full API definitions
- **706 Public Symbols** (380 runtime values, 326 TypeScript types)
