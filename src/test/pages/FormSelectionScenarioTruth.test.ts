...
describe("form selection scenario truth", () => {
	...
	it("keeps field hint and error ids aligned with preview", () => {
		...
		expect(hint.code).toContain("htmlFor={id}");
		expect(hint.code).toContain("id={id}");
		...
		expect(error.code).toContain("htmlFor={id}");
		expect(error.code).toContain("id={id}");
	...
	it("keeps checkbox and switch codes named like their renders", () => {
		...
		expect(checkboxError.code).toContain("htmlFor={id}");
		expect(checkboxError.code).toContain('error="Required"');
		expect(checkboxError.code).toContain("id={id}");
	...
	it("keeps standalone inputs named and input groups labelled", () => {
		...
		expect(labeled.code).toContain("htmlFor={id}");
		expect(labeled.code).toContain("id={id}");
		...
		expect(areaLabel.code).toContain("htmlFor={id}");
		expect(areaLabel.code).toContain("id={id}");
		...
		expect(areaError.code).toContain("htmlFor={id}");
		expect(areaError.code).toContain("id={id}");
