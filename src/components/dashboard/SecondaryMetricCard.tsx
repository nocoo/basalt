    ...
    <Card className="h-full rounded-card border-0 bg-secondary shadow-none">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-sm font-normal text-muted-foreground">{t("dashboard.income")}</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="flex flex-col">
        <div className="flex flex-col flex-1 rounded-widget border border-border p-4">
          ...
          <div className="mt-3 flex-1 min-h-[50px]" role="img" aria-label={t("dashboard.incomeAria")}>
