    ...
    <Card className="h-full rounded-card border-0 bg-secondary shadow-none">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-sm font-normal text-muted-foreground">{t("dashboard.usageCategory")}</CardTitle>
        </div>
      ...
      <CardContent className="flex flex-col">
        <div className="flex-1 min-h-[200px]" role="img" aria-label={t("dashboard.usageCategoryAria")}>
