		...
		<div className="min-h-screen bg-background p-2 md:p-4 flex items-center justify-center">
			<div className="mx-auto w-full max-w-2xl rounded-[16px] md:rounded-[20px] bg-card p-6 md:p-10">
				...
				<div className="space-y-4 mb-8">
					...
					<p className="text-sm text-muted-foreground">{t("pages.static.lastUpdated")}</p>
				</div>

				{/* Body */}
				<div className="space-y-6 text-sm">
					<section>
						<h3 className="font-semibold mb-2 text-base">{t("pages.static.section1Title")}</h3>
					...
					<section>
						<h3 className="font-semibold mb-2 text-base">{t("pages.static.section2Title")}</h3>
					...
					<section>
						<h3 className="font-semibold mb-2 text-base">{t("pages.static.section3Title")}</h3>
						<p className="text-muted-foreground leading-relaxed mb-2">
					...
					<section>
						<h3 className="font-semibold mb-2 text-base">{t("pages.static.section4Title")}</h3>
						<p className="text-muted-foreground leading-relaxed">
					...
					<section>
						<h3 className="font-semibold mb-2 text-base">{t("pages.static.section5Title")}</h3>
						<p className="text-muted-foreground leading-relaxed">
					...
					<div className="pt-4 border-t">
						<p className="text-muted-foreground text-xs">{t("pages.static.footerText")}</p>
					</div>
				</div>
			</div>
		</div>
