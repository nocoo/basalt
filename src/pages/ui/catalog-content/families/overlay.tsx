...
function scenarioModule(code: string, imports: string[], helpers?: string): string {
	...
	const helpersBlock = helpers ? `\n\n${helpers}` : "";
	return `${importLines}${helpersBlock}\n\nexport default function Example() {\n\treturn (\n\t\t${code.split("\n").join("\n\t\t")}\n\t);\n}`;
}
...
const DIALOG_HEADER_HELPERS = `function DialogCloseButton() {
	return (
		<DialogClose asChild>
...
const DIALOG_FOOTER_HELPER = `function DialogFooter({
	cancel = "Cancel",
	action = "Delete",
...
const DIALOG_ALL_HELPERS = `${DIALOG_HEADER_HELPERS}\n\n${DIALOG_FOOTER_HELPER}`;
...
export default function Example() {
	...
	<AccordionItem value="a">
		...
		<AccordionContent>Body</AccordionContent>
					...
					[
						'import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@nocoo/basalt/components/accordion";',
					],
				),
				render: () => (
					<Accordion type="single" collapsible>
	...
	<AlertDialogContent>
		...
		<div className="mt-8 flex justify-end gap-2">
			...
			<AlertDialogAction>Delete Account</AlertDialogAction>
					...
					[
						'import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogTitle, AlertDialogTrigger } from "@nocoo/basalt/components/alert-dialog";',
						'import { Button } from "@nocoo/basalt/components/button";',
			...
			<DialogClose asChild>
				<Button variant="outline">Close</Button>
					...
					[
						'import { Button } from "@nocoo/basalt/components/button";',
						'import { Dialog, DialogClose, DialogContent, DialogDescription, DialogTitle, DialogTrigger } from "@nocoo/basalt/components/dialog";',
						'import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "@nocoo/basalt/components/dropdown-menu";',
						'import { X } from "lucide-react";',
					],
					DIALOG_HEADER_HELPERS,
				),
...
export default function Example() {
	...
	<PopoverContent>
		...
		<PopoverDescription>This is a popover.</PopoverDescription>
					...
					[
						'import { Button } from "@nocoo/basalt/components/button";',
						'import { Popover, PopoverContent, PopoverDescription, PopoverTitle, PopoverTrigger } from "@nocoo/basalt/components/popover";',
					],
				),
				render: () => (
					<Popover>
