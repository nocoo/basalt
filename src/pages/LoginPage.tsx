      ...
      <div className="relative w-full max-w-[420px]">
        ...
        <Card className="rounded-[14px] border-0 bg-card shadow-none">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="rounded-[10px] border-border bg-secondary pl-10 text-sm placeholder:text-muted-foreground focus-visible:ring-primary"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="rounded-[10px] border-border bg-secondary pl-10 pr-10 text-sm placeholder:text-muted-foreground focus-visible:ring-primary"
                />
                <button
                  type="button"
            ...
            {/* Sign in button */}
            <button className="flex w-full items-center justify-center gap-2 rounded-[10px] bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90">
              Sign in
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 rounded-[10px] bg-secondary px-4 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent">
