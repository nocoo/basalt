...
import "@nocoo/basalt/styles/tailwind";`),
	...
	it("keeps the committed standalone fixture inside the gate contract", () => {
		...
		expect(manifest).toContain('"lucide-react": "1.42.0"');
	...
	it("does not embed a developer home path in this slice", () => {
		...
		const files = [
			...
			"fixtures/vite-standalone/geometry.html",
			"fixtures/vite-standalone/src/geometry.tsx",
			"fixtures/vite-standalone/src/geometry-app.tsx",
			"fixtures/vite-standalone/dock.html",
			"fixtures/vite-standalone/src/dock.tsx",
			"fixtures/vite-standalone/src/dock-app.tsx",
			"fixtures/vite-standalone/confirm.html",
			"fixtures/vite-standalone/src/confirm.tsx",
			"fixtures/vite-standalone/src/confirm-app.tsx",
			"fixtures/vite-standalone/portal.html",
			"fixtures/vite-standalone/src/portal.tsx",
			"fixtures/vite-standalone/src/portal-app.tsx",
			"fixtures/vite-standalone/toast.html",
			"fixtures/vite-standalone/src/toast.tsx",
			"fixtures/vite-standalone/src/toast-app.tsx",
			"fixtures/vite-standalone/slider.html",
			"fixtures/vite-standalone/src/slider.tsx",
			"fixtures/vite-standalone/src/slider-app.tsx",
			"fixtures/vite-standalone/calendar.html",
			"fixtures/vite-standalone/src/calendar.tsx",
			"fixtures/vite-standalone/src/calendar-app.tsx",
...
`;
	...
	it("does not embed a developer home path in the tailwind slice", () => {
		...
		const files = [
			...
			"fixtures/vite-tailwind/geometry.html",
			"fixtures/vite-tailwind/src/geometry.tsx",
			"fixtures/vite-tailwind/src/geometry-app.tsx",
			"fixtures/vite-tailwind/dock.html",
			"fixtures/vite-tailwind/src/dock.tsx",
			"fixtures/vite-tailwind/src/dock-app.tsx",
			"fixtures/vite-tailwind/confirm.html",
			"fixtures/vite-tailwind/src/confirm.tsx",
			"fixtures/vite-tailwind/src/confirm-app.tsx",
			"fixtures/vite-tailwind/portal.html",
			"fixtures/vite-tailwind/src/portal.tsx",
			"fixtures/vite-tailwind/src/portal-app.tsx",
			"fixtures/vite-tailwind/toast.html",
			"fixtures/vite-tailwind/src/toast.tsx",
			"fixtures/vite-tailwind/src/toast-app.tsx",
			"fixtures/vite-tailwind/slider.html",
			"fixtures/vite-tailwind/src/slider.tsx",
			"fixtures/vite-tailwind/src/slider-app.tsx",
			"fixtures/vite-tailwind/calendar.html",
			"fixtures/vite-tailwind/src/calendar.tsx",
			"fixtures/vite-tailwind/src/calendar-app.tsx",
