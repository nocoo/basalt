...
| 04 | [04-systematic-library-review.md](./04-systematic-library-review.md) | **系统审查与实施台账**：P1 已验收，P2 源码 API、99 个主用法与 246 场景正式编译门已分组验收，正补齐随包 registry 与接入指南；后续含复杂 Skeleton/Table Library、Example 与下游复用 |
