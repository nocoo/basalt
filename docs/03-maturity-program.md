...
> 状态：执行中  
> 当前切片：S2A9 D037 — Separator source-backed scenarios；待 Grok 实现
> 当前代码前置：`754b72c`（D036 验收台账已提交）
...
| S2A | 类型驱动的 docs/API/scenario 数据模型 | 执行中（S2A1 D028、S2A2 D030、S2A3 D031、S2A4 D032、S2A5 D033、S2A6 D034、S2A7 D035、S2A8 D036 完成） | 组件类型、API 表、example 不再三份手写漂移 |
...
| D037 | S2A9 | `754b72c` | `w14:p1` | 准备下发 | — | 将当前唯一 Separator composite scenario 迁为同路径 render/raw 真源，删除 BASE/KUMO 双 owner 与假代码；冻结生产组件、API、视觉及其它阶段。 |
