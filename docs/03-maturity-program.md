...
> 状态：执行中  
> 当前切片：S2A14 D042 — Tooltip API type source；准备下发
> 当前代码前置：`adcf5ba`（D041 实现已验收）
...
| S2A | 类型驱动的 docs/API/scenario 数据模型 | 执行中（S2A1 D028、S2A2 D030、S2A3 D031、S2A4 D032、S2A5 D033、S2A6 D034、S2A7 D035、S2A8 D036、S2A9 D037、S2A10 D038、S2A11 D039、S2A12 D040、S2A13 D041 完成） | 组件类型、API 表、example 不再三份手写漂移 |
...
| D042 | S2A14 | `3d258ab` | `w14:p1` | 准备下发 | — | 为 Tooltip Root 建立等价公开 `TooltipProps` 真源，只生成 optional `delayDuration`；保持 primitive runtime identity，冻结 Provider/Trigger/Content 与 Kumo-only 简化能力。 |
