...
> 状态：执行中  
> 当前切片：S2A11 D039 — source-backed Link scenarios；待 Grok 实现
> 当前代码前置：`4bb5a37`（D038 验收台账已提交）
...
| S2A | 类型驱动的 docs/API/scenario 数据模型 | 执行中（S2A1 D028、S2A2 D030、S2A3 D031、S2A4 D032、S2A5 D033、S2A6 D034、S2A7 D035、S2A8 D036、S2A9 D037、S2A10 D038 完成） | 组件类型、API 表、example 不再三份手写漂移 |
...
| D039 | S2A11 | `4bb5a37` | `w14:p1` | 准备下发 | — | 将 Link 当前三个生效场景迁为独立 source-backed modules，删除 BASE/KUMO 双 owner；冻结现有 DOM、导航属性、API、视觉和 Kumo-only 能力。 |
